...
@Component({
  selector: 'app-details-article-non-auth',
  templateUrl: './details-article-non-auth.component.html',
  styleUrls: ['./details-article-non-auth.component.css']
})
export class DetailsArticleNonAuthComponent implements OnInit {
